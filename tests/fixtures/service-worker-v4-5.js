...
const RELEASE_ID = "20260903-v4-5";
const CACHE_NAME = `${CACHE_PREFIX}offline-v4-1`;
...
self.addEventListener("install", (event) => {
  event.waitUntil((async () => {
    // RELEASE_ID exists to force a byte-level Service Worker update even when
    // the cache namespace itself remains compatible with v4.1.
    void RELEASE_ID;
